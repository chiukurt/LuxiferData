...
- Simulates sync loading and hides the page to load Matomo and Matomo tag manager scripts. (does not block loading, only simulates sync loading but is async)
